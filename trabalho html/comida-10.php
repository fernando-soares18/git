...
$comida10 = array_values(array_filter($artigos, static function (array $artigo): bool {
    return isset($artigo['categoria']) && trim((string) $artigo['categoria']) === 'Comida 10';
}));

usort($comida10, static function (array $a, array $b): int {
    $ordemA = (int) ($a['ordem'] ?? 9999);
    $ordemB = (int) ($b['ordem'] ?? 9999);
...
foreach ($comida10 as $artigo) {
    ...
    $comida10Unicos[] = $artigo;
}

$comida10 = array_slice($comida10Unicos, 0, 5);
...
<main>
    ...
    <section class="cat-list">
        <div class="container">
            <?php if (empty($comida10)): ?>
                <div class="cat-empty">Nenhum artigo encontrado para a categoria Comida 10.</div>
            <?php else: ?>
                <div class="cat-grid">
                    <?php foreach ($comida10 as $artigo): ?>
