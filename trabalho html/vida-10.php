...
$vida10 = array_values(array_filter($artigos, static function (array $artigo): bool {
    return isset($artigo['categoria']) && trim((string) $artigo['categoria']) === 'Vida 10';
}));

usort($vida10, static function (array $a, array $b): int {
...
$vida10 = array_slice($vida10Unicos, 0, 5);
...
<head>
    ...
    <title>Vida 10 | Dr. Charles Genehr</title>
...
<main>
    <section class="cat-hero">
        <div class="container">
            <p class="eyebrow" style="color:#d5f0e8;">Vida 10</p>
            <h1>Artigos para estilo de vida integral</h1>
    ...
    <section class="cat-list">
        <div class="container">
            <?php if (empty($vida10)): ?>
                <div class="cat-empty">Nenhum artigo encontrado para a categoria Vida 10.</div>
            <?php else: ?>
                <div class="cat-grid">
                    <?php foreach ($vida10 as $artigo): ?>
