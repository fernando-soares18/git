...
$corpo10 = array_values(array_filter($artigos, static function (array $artigo): bool {
    return isset($artigo['categoria']) && trim((string) $artigo['categoria']) === 'Corpo 10';
}));

usort($corpo10, static function (array $a, array $b): int {
...
foreach ($corpo10 as $artigo) {
    ...
    $corpo10Unicos[] = $artigo;
}

$corpo10 = array_slice($corpo10Unicos, 0, 5);
...
<head>
    ...
    <title>Corpo 10 | Dr. Charles Genehr</title>
...
<main>
    <section class="cat-hero">
        <div class="container">
            <p class="eyebrow" style="color:#d5f0e8;">Corpo 10</p>
            <h1>Artigos para vitalidade corporal</h1>
    ...
    <section class="cat-list">
        <div class="container">
            <?php if (empty($corpo10)): ?>
                <div class="cat-empty">Nenhum artigo encontrado para a categoria Corpo 10.</div>
            <?php else: ?>
                <div class="cat-grid">
                    <?php foreach ($corpo10 as $artigo): ?>
