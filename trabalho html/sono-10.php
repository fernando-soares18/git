...
$sono10 = array_values(array_filter($artigos, static function (array $artigo): bool {
    return isset($artigo['categoria']) && trim((string) $artigo['categoria']) === 'Sono 10';
}));

usort($sono10, static function (array $a, array $b): int {
...
<head>
    ...
    <title>Sono 10 | Dr. Charles Genehr</title>
...
<main>
    <section class="cat-hero">
        <div class="container">
            <p class="eyebrow" style="color:#d5f0e8;">Sono 10</p>
            <h1>Artigos para sono restaurador</h1>
    ...
    <section class="cat-list">
        <div class="container">
            <?php if (empty($sono10)): ?>
                <div class="cat-empty">Nenhum artigo encontrado para a categoria Sono 10.</div>
            <?php else: ?>
                <div class="cat-grid">
                    <?php foreach ($sono10 as $artigo): ?>
